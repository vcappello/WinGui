...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)../WinGui 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)WinGui 
ArLibs                 :=  "WinGui" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)../WinGui/Debug 
...
$(OutputFile): $(IntermediateDirectory)/.d "..\.build-debug\WinGui" $(Objects) 
	@$(MakeDirCommand) $(@D)
